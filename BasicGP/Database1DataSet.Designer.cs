...
namespace BasicGP {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class patientDataTable : global::System.Data.TypedTableBase<patientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public patientRow AddpatientRow(string First_name, string Last_name, int Phone_number, string address) {
...
namespace BasicGP.Database1DataSetTableAdapters {
    ...
    public partial class patientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[patient] WHERE (([Id] = @Original_Id) AND ([First name] = @Ori" +
                "ginal_First_name) AND ([Last name] = @Original_Last_name) AND ([Phone number] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[patient] ([First name], [Last name], [Phone number], [address]" +
                ") VALUES (@First_name, @Last_name, @Phone_number, @address);\r\nSELECT Id, [First " +
                "name], [Last name], [Phone number], address FROM patient WHERE (Id = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[patient] SET [First name] = @First_name, [Last name] = @Last_name, [Phone number] = @Phone_number, [address] = @address WHERE (([Id] = @Original_Id) AND ([First name] = @Original_First_name) AND ([Last name] = @Original_Last_name) AND ([Phone number] = @Original_Phone_number));
SELECT Id, [First name], [Last name], [Phone number], address FROM patient WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BasicGP.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [First name], [Last name], [Phone number], address FROM dbo.patient";
        ...
        public virtual int Delete(int Original_Id, string Original_First_name, string Original_Last_name, int Original_Phone_number) {
        ...
        public virtual int Insert(string First_name, string Last_name, int Phone_number, string address) {
            if ((First_name == null)) {
        ...
        public virtual int Update(string First_name, string Last_name, int Phone_number, string address, int Original_Id, string Original_First_name, string Original_Last_name, int Original_Phone_number, int Id) {
            if ((First_name == null)) {
                throw new global::System.ArgumentNullException("First_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First_name, string Last_name, int Phone_number, string address, int Original_Id, string Original_First_name, string Original_Last_name, int Original_Phone_number) {
            return this.Update(First_name, Last_name, Phone_number, address, Original_Id, Original_First_name, Original_Last_name, Original_Phone_number, Original_Id);
        }
    }
